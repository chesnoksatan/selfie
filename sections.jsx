...
const KDE = [
  ...
  { name: 'kcm_keyboard', desc: 'Модуль настроек клавиатуры. Тоже полный перевод с QtWidgets на QML и редизайн интерфейса.', tag: 'rewrite + redesign' },
  { name: 'kirigami-addons', desc: 'В QML работа с таблицами поддержана слабо — каждому приложению приходилось стилизовать их самому. Я написал модуль, который можно подключить и сразу получить таблицу, выглядящую как часть KDE.', tag: 'new module' },
  { name: 'misc', desc: 'Помимо крупных задач — точечные исправления багов в разных компонентах KDE.', tag: 'bugfixes' },
  { name: 'QuickQanava', desc: 'Не KDE, но важная для меня страница. Когда-то на работе мне не хватило пары свойств у объектов в этой библиотеке — я их добавил, отправил PR, и они попали в релиз. Мой первый вклад в чужой опенсорс.', tag: 'первый контрибьют' },
];
...
function ContactsSection() {
  const items = [
    { label: 'Email', value: 'chestwins@gmail.com.com', href: 'mailto:chestwins@gmail.com.com' },
